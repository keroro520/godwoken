...
use gw_utils::{
    fee::fill_tx_fee_with_local, genesis_info::CKBGenesisInfo, get_confirmed_header,
...
impl BlockProducer {
    ...
    pub async fn produce_next_block(
        ...
        let l1_confirmed_header_timestamp = l1_confirmed_header.inner.timestamp.value();
